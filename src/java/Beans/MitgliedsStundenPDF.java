...
public class MitgliedsStundenPDF implements Serializable
{
    ...
    public MitgliedsStundenPDF(String strStammblattnummer, String strDienstgrad, String strTitel, String strVorname, String strZuname, int intMinutenEb, int intMinutenTb, int intMinutenUb)
    {
